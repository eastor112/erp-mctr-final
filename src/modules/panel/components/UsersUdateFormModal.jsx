...
export const UsersUdateFormModal = () => {
  return (
    <>
      ...
      <section>
        ...
        <div>
          <h4>
            Nombre completo: Emerson Maximo Asto Rodriguez
          </h4>
          <p>ID Usuario:</p>
          <p>Campus: Trujillo</p>
          <p>Facultad: Ingenieria</p>
          <p>Departamento Ingeniria Mecatrónica</p>
          <p>Escuela: Ingeniería Mecatrónica</p>
          <p> Tipo de usuario: Docente</p>
          <p> Numero celular: 926569656 </p>
          <p>Ultima conexion: 2021-07-13T13:59:29-05:00</p>

          <p>codigo estudiante: 523600109</p>
          <p>Graduado: Si</p>

          <p>Codigo docente: 50868</p>
          <p>Categoría: Auxiliar</p>
          <p>Profesion: Ingeniero Mecatrónico</p>
          <p>Grado Académico: Maestro</p>
          <p>Tipo de servicios: Contratado</p>
          <p>Dedicación: Tipo B - 32 Horas</p>
          <p>Cargo de apoyo: Miembro de comité de calidad</p>
        </div>
